...
const styles = StyleSheet.create({
  ...
  cardDate: { flex: 1, fontSize: 12, color: Colors.textSecondary },
  cardPrice: { fontSize: 16, fontWeight: '800', color: Colors.primary },
  cardRoute: { gap: 4 },
  cardOrigin: { fontSize: 13, color: Colors.textPrimary },
  cardDest: { fontSize: 13, color: Colors.textPrimary },
  cardPassenger: { fontSize: 12, color: Colors.textMuted },
});
