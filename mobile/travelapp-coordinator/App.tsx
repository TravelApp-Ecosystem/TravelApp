        ...
        {showSplash && (
          <Animated.View style={[styles.splashContainer, { opacity: splashOpacity }]}>
            ...
            <View style={styles.centerContainer}>
              <TravelAppLogo size={90} textColor={Colors.white} isAccentColor={false} />
              <Text style={{ color: Colors.white, fontSize: 20, fontFamily: 'Quicksand-Bold', marginTop: 16 }}>Coordinador</Text>
            </View>

            {/* Footer en Blanco */}
            <View style={styles.footerContainer}>
              <Text style={styles.footerTextMuted}>Panel de Control Móvil</Text>
