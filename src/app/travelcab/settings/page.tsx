            ...
            <div className="lg:col-span-1">
              <div className="rounded-xl border border-slate-200 bg-white/40 p-6 shadow-lg">
                ...
                <form onSubmit={handleSaveCategory} className="space-y-4">
                  ...
                  <div>
                    <label className="mb-1 block text-xs font-semibold text-slate-500">Icono Representativo</label>
                    <select
                      value={categoryForm.icon}
                      onChange={(e) => setCategoryForm({...categoryForm, icon: e.target.value})}
                      className="w-full rounded-md border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-tech-blue focus:border-vial-orange focus:outline-none"
                    >
                      <option value="Car">Sedán Común (Auto)</option>
                      <option value="Crown">Corona (VIP / Lujo)</option>
                      <option value="Sparkles">Destellos (Premium)</option>
