...
export const INITIAL_ACCOUNTS: BankAccount[] = [
  ...
  { id:'a4', name:'Mercado Pago', type:'billetera', currency:'ARS', balance:0, businessUnit:'Global', status:'active', cbuCvu:'0000003100058765432100', alias:'travelapp.ecosistema', branch:'Billetera Digital' },
